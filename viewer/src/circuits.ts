...
/** Human-readable names for the display groups (amongusfly/connectome/layout.py DISPLAY_GROUPS). */
...
/** Display order: the pathways that carry most of the behaviour come first. */
 ...
 * Rates come from that fly's recorded spikes.
 */
